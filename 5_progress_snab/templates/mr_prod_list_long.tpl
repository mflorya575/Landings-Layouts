        ...
        <div class="catalog-longlist__card">
            <div class="catalog-longlist__wrap">
                <div class="catalog-longlist__image">
                    <a href="{$item.url}"><img src="{if $item.pic}{$item.pic}{else}/assets/images/catalog/defelectro_long.png{/if}"></a>
                </div>
                <div class="catalog-longlist__info-wrap">
                    <div class="catalog-longlist__info">
                        <div class="catalog-longlist__name"><a href="{$item.url}"  class="products__card-title">{$item.title}</a></div>
                        <div class="catalog-longlist__price">
                            {if $item.price}  {$item.price} {if $item.edizm==1}₽{elseif $item.edizm==2}₽{elseif $item.edizm==3}₽{/if}
                            {else}
            ...
            <div class="catalog-longlist__text--code">
                ...
                <span class="catalog-longlist__text--blue">{$item.artikul}</span>
            </div>
        </div>
    </div>
    {/foreach}
