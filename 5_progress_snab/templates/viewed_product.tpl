                    ...
                    <div class="watched__wrapper swiper-wrapper">
                        {foreach $viewed as $item}
                            <div class="product_container products-card swiper-slide" data-price="{$item.price}" data-innercode="{$item.innercode}"  data-pid="{$item.pid}">
                                ...
                                {/if}
                                <div class="products__card-image_modules">
                                    <img src="{if $item.pic}{$item.pic}{else}/assets/images/catalog/defelectro_modules.png{/if}" alt="">
                                </div>
                                <div class="products__card-specification">
                                    <div class="products__card-title" style="height:150px !important;"><a href="{$item.url}" class="products__card-title">{$item.position}</a></div>
