        ...
        <td style="padding:30px 0;">
            <div style="width: 800px;  margin: 0 auto;  background: #fff;">
                ...
                <div style="padding: 25px 20px 40px 20px;">
                    <p style="margin-bottom: 8px; font-size: 20px; line-height: 23px; font-weight: 600;">
                        Заказ обратного звонка с сайта <a href="{$mainurl}">{$sitename}</a>
                    </p>
                    <p style="margin-bottom: 16px; font-size: 14px; line-height: 22px; color: #2C7069;">
                        Телефон: <b>{$phone}</b><br>
                        Время заказа:  <b>{$time}</b><br>
                        IP адрес: <a href="https://apps.db.ripe.net/db-web-ui/query?searchtext={$IP}">{$IP}</a>
                    </p>
                </div>
