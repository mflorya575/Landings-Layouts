...
<head>
  ...
  <title>Обработка персональных данных в "{$company.name}"</title>
...
<body>
  <div class="page" id="to-top">
    ...
    <main class="main">
      <div class="about">
        <div class="container">
          <div class="about__background" style="margin-top:0px">
            <img src="/assets/images/about-background.png" alt="">
          </div>
          <div class="about__subtitle" style="max-width:600px;font-weight:bold;margin-left:-30px;margin-top:70px"><i>Керосиновая лампа — уютнейшая вещь, но мы, по примеру классика, за электричество!</i></div>
        </div>
      ...
      <div class="textblock">
          ...
          <p>
              ...
              «Оператор персональных данных» - ООО «ТК Инком», осуществляющее свою деятельность по адресу — Российская Федерация, г. Санкт-Петербург, ул. Коли Томчака, д.28, лит.Л, офис 12<br>
          ...
          <p>
              ...
              - регулирования трудовых отношений с работниками ООО «ТК Инком» (содействие в трудоустройстве, обучение и продвижение по службе, обеспечение личной безопасности, контроль количества и качества выполняемой работы, обеспечение сохранности имущества, предоставлления льгот и компенсаций, предусмотренных законодательством РФ);<br>
          ...
          <p>
              ...
              - назначение лица, ответственного за организацию обработки персональных данных в ООО «ТК Инком»;<br>
          ...
          <p>
              ...
              - обжалование действий или бездействий ООО «ТК Инком», осуществляемых в области персональных данных, в уполномоченный орган по защите прав субъектов персональных данных или в суд;<br>
          ...
          <p>
              8.2. Во всем ином, что не установлено настоящей политикой, необходимо руководствоваться действующим законодательством РФ, нормами международного права в области персональных данных, локальными актами, принятыми в ООО «ТК Инком».
