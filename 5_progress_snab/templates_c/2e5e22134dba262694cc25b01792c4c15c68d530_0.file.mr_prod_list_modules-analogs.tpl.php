...
/* Smarty version 3.1.34-dev-7, created on 2024-05-20 12:35:29
  from '/var/www/progresselektro.ru/assets/templates/mr_prod_list_modules-analogs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_664b1961820195_14097604',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2e5e22134dba262694cc25b01792c4c15c68d530' => 
    array (
      0 => '/var/www/progresselektro.ru/assets/templates/mr_prod_list_modules-analogs.tpl',
      1 => 1713052180,
      2 => 'file',
    ),
  ),
...
function content_664b1961820195_14097604 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['analogs']->value) {?>
    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['analogs']->value, 'item');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['item']->value) {
?>

        <?php if ($_smarty_tpl->tpl_vars['item']->value['stocksInfo']['short']) {?>
        <div class="modal modal-available" id="analog_cities_main_<?php echo $_smarty_tpl->tpl_vars['item']->value['pid'];?>
">
...
} else { ?>/assets/images/defcable_long.png<?php }?>"></a>
                    </div>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] == 1) {?>
                            <div class="product-card__about-available">
                              <div class="product-card__about-available-col">
                                  <?php if ($_smarty_tpl->tpl_vars['item']->value['stocksInfo']['full']) {?>
                                  <?php
...
">
                                          <p>в <?php echo $_smarty_tpl->tpl_vars['v']->value['city']['city_name_2'];?>
</p>
                                          <span>&nbsp;<?php echo $_smarty_tpl->tpl_vars['v']->value['total_str'];?>
 м</span>
                                      </div>
                                  <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                  ...
                                  <div class="product-card_check-available" onclick="openModal('#analog_cities_main_<?php echo $_smarty_tpl->tpl_vars['item']->value['pid'];?>
')">
